...
for kk=1:channel_num
    ...
    fft_ecog_data(:,kk)=fft(ecog_data(:,kk),N);
...
title('PSD Using FFT with zeroPadding : Channel 7');
xlabel('Frequency (Hz)');
ylabel('Power/Frequency (dB/Hz)');
saveas(h1,fullfile(out_dir,sprintf('PSD_FFT with_zeroPadding_Channel7.png')))
