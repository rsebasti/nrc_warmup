...
for kk=1:channel_num
    ...
    fft_ecog_data(:,kk)=fft(filt_ecog_data(:,kk));
...
title('PSD Using notch filtered FFT without zeroPadding : Channel 7');
xlabel('Frequency (Hz)');
ylabel('Power/Frequency (dB/Hz)');
saveas(h1,fullfile(out_dir,sprintf('PSD_Using_notch_filtered_FFT without_zeroPadding_Channel7.png')))
